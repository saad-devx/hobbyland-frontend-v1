...
function Index({ socket }) {
    ...
    const initiateMeeting = async (_, outgoing = true) => {
        try {
            ...
            console.log("Point 2: Emitted the join meeting socket event and set the states.")
            ...
            console.log("Point 5: Subscribed to the consumer transport and hydrated the producers and streams.")
        ...
        <div className="relative w-full h-screen bg-gray-100">
            {room_id ? (otherMember ?
                <div className="Header_Top">
                    ...
                    <div onClick={() => initiateMeeting(null, true)} className="padingleft" style={{ cursor: "pointer" }}>
